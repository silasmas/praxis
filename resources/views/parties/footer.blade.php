    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 mb-1-9 mb-lg-0 wow fadeIn" data-wow-delay="200ms">
                ...
                <p class="mb-1-9 text-white w-xxl-85">We assist you to develop up your flourishing commercial
                    enterprise.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-4 mb-1-9 mb-lg-0 wow fadeIn" data-wow-delay="500ms">
                        ...
                        <ul class="ps-0 mb-0">
                            ...
                            <li><a href="our-core-values.html">Core Values</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p>&copy; <span class="current-year"></span> Sperty is Powered by <a href="#!"
                            class="text-secondary text-primary-hover">Website Design Templates</a></p>
                </div>
            </div>
        </div>
    </div>
