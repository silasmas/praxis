                                ...
                                <div class="col-lg-6 wow fadeIn position-relative" data-wow-delay="400ms">
                                    <div class="pt-lg-1-9 pt-xxl-6 ps-lg-1-6 ps-xxl-6">
                                        ...
                                        <ul class="list-unstyled mb-1-9">
                                            <li class="mb-2"><span class="fs-5 me-2 font-weight-600">Position:</span> {{ $prof->titre }}</li>
                                            <li class="mb-2"><span class="fs-5 me-2 font-weight-600">Experience:</span>@lang("info.titre.experience")</li>
                                            <li class="mb-2"><span class="fs-5 me-2 font-weight-600">Email:</span> @lang("info.titre.mail")</li>
                                            {{-- <li class="mb-2"><span class="fs-5 me-2 font-weight-600">Website:</span> www.example.com</li> --}}
                                            <li><span class="fs-5 me-2 font-weight-600">Phone:</span> @lang("info.titre.phone")</li>
                                        </ul>
                                        <div>
                                            <ul class="ps-0 mb-0 social-icons-style1">
                                                <li><a target="blank" href="{{ $prof->fb }}"><i class="fab fa-facebook-f"></i></a></li>
                                                <li><a target="blank" href="{{ $prof->insta }}"><i class="fab fa-instagram"></i></a></li>
                                                <li><a target="blank" href="{{ $prof->x }}"><i class="fab fa-youtube"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    {{-- <img src="img/content/sign.png" class="position-absolute right-5 bottom-n5 d-none d-sm-block" alt="..."> --}}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 wow fadeIn" data-wow-delay="400ms">
                                    <div class="bg-white border-radius-10 shadow-light p-1-9 wow fadeIn" data-wow-delay="200ms">
                                        ...
                                        <form class="contact quform" id="formContactProf">
                                            <div class="quform-elements">
                                                <div class="row">
                                                    <!-- Begin Text input element -->
                                                    <input hidden class="form-control" value="{{ isset($prof)?$prof->id:"" }}" id="enseignant_id" type="text" name="enseignant_id" placeholder="" />
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="quform-element form-group">
                                                            ...
                                                            <div class="quform-input">
                                                                <textarea class="form-control h-100" id="message" name="message" rows="3" placeholder="Laissez moi votre message"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
